<script>
    import { ChevronDoubleDown, Plus } from 'svelte-hero-icons'
...
<div class='space-y-4 mt-16'>
    <div class='card'>
        <h4 class='header items-center'>Typography
            <Icon src={ChevronDoubleDown} class='icon'/>
        </h4>
        <h1>Header 1 </h1>
        <h2>Header 2</h2>
        <h3>Header 3</h3>
    ...
    <div class='grid sm:grid-cols-2 md:grid-cols-4 gap-2 items-start'>
        <div>
        ...
        <div class='card '>
            ...
            <img class='outlined mt-2' src={wingsImage} alt=''>
